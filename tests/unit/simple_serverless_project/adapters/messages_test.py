...
from simple_serverless_project.adapters.messages import (
    internal_to_wire,
    wire_to_internal,
)
from simple_serverless_project.contracts.inputs.telegram import (
    Message as InMessage,
)
from simple_serverless_project.models.messages import Message
