...
from simple_serverless_project.schema.aws import LambdaApiRequest
from simple_serverless_project.ports.http_inputs import webhook
...
@patch('simple_serverless_project.components.telegram.requests.post')
def test_webhook(mock_req, event: LambdaApiRequest):
